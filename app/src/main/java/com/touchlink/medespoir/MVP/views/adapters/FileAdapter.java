...
public class FileAdapter extends RecyclerView.Adapter<FileAdapter.MyViewHolder> {
    ...
    private List<Operationimage> listOfFiles;
    private FileListener listener ;


    public FileAdapter(Context context , FileListener listener, List<Operationimage> listOfFiles){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FileAdapter.MyViewHolder(view , listener);

    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Operationimage file = listOfFiles.get(position);
    ...
    public void refresh(List<Operationimage> listOfFiles) {
        listOfFiles.clear();
