...
public class InterventionsAdapter extends RecyclerView.Adapter<InterventionsAdapter.MyViewHolder> {
    ...
    public InterventionsAdapter(Context context , InterventionListener listener,List<Interventions> listOfInterventions){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_card_intervention, parent, false);
        return new InterventionsAdapter.MyViewHolder(view , listener);
